...
echo "  1. give the agent its key (opencode: add to ~/.local/share/opencode/auth.json;"
echo "     kilo: add a provider block to ~/.config/kilo/kilo.jsonc; hermes: add to"
echo "     ~/.hermes/auth.json credential_pool) - see docs/SETUP.md section 2"
echo "  2. run:  fa refresh"
