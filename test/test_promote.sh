...
write_fixture
bash "${LEGACY_DIR}/promote.sh" researcher research opencode/x opencode success >/dev/null 2>&1
...
write_fixture
bash "${LEGACY_DIR}/promote.sh" researcher research opencode/x opencode failure >/dev/null 2>&1
...
write_fixture
bash "${LEGACY_DIR}/promote.sh" researcher research opencode/x opencode rate_limited >/dev/null 2>&1
...
write_fixture
bash "${LEGACY_DIR}/promote.sh" researcher research kilo/new kilo success >/dev/null 2>&1
